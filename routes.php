...
get('/gpsm','server/gps/gps.php');
get('/gpslogsdata', 'server/gps/logs/gps.data');
get('/gpslogs','server/gps/gps-logbase.php');
get('/gpslogsdatacurrent','server/gps/logs/gps-current.data');
// POST
