...
<div class="container">
    <div class="mx-5 px-5">
        <?php require_once 'include/nav-admin-logs.php' ?>
        ...
        <div class="d-flex justify-content-between bg-glass p-3 w-100 border align-items-center mb-2">
            ...
            <div class="input-group " style="width: 23%;">
                ...
                <select onchange="val()" id="select_id2" class="form-control" name="filter" aria-label="Small select">
                    <option value="all">ALL</option>
...
<script>
    ...
    function val() {
        ...
        e = document.getElementById("select_id2").value;
    }
    ...
    function loadDoc() {
        ...
        xhttp.onload = function() {
            ...
            console.log("/logs-retrieve?event=" + d + "&type=" + e);

        };

        xhttp.open("GET", "/logs-retrieve?event=" + d + "&type=" + e, true);
        xhttp.send();
