   ...
   <div class="container-fluid">
     ...
     <div class="collapse navbar-collapse" id="navbarColor01">
       <ul class="navbar-nav me-auto">
         ...
         <li class="nav-item">
           <a class="nav-link  active disabled" href="/about">About</a>
         </li>
         <li class="nav-item">
         ...
         <li class="nav-item dropdown">
           ...
           <div class="dropdown-menu">
             <a class="dropdown-item" href="https://github.com/dinogomez/htdocs" target="_blank">Source Code <i class="fa-brands fa-github fa-lg"></i></a>
             <div class="dropdown-divider"></div>
             <a class="dropdown-item" href="/document" target="_blank">Research Document <i class="fa-solid fa-file-lines fa-lg text-success"></i></a>
           </div>
         </li>
       </ul>
