  ...
  <i class="navbar-brand bg-morph text-dark p-2 rounded shadow-lg fa-solid fa-paw"></i>
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      ...
      <form class="d-flex" action="/search" method="GET" method="GET">
        ...
        <a class="btn btn-secondary nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">👋Hi, <?php echo $_SESSION['username']?></a>
