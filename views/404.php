...
<div class="container p-3 col-4 shadow text-center wrapper">

    <div class="bg-morph p-5">
        <div class="d-flex">
            <a href="/" class="float-start text-dark fs-6 text-decoration-none" aria-label="Close"><i class="fa-solid fa-left-long"></i> Return</a>

        </div>
        <h1 class="display-6 font-rubik"><span class="text-danger">404</span><br>cannot find address</h1>
