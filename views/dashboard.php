      ...
      <section>
        ...
        <div class="row mt-4">
          <div class="col-12 mt-3 mb-1">
            ...
            <p>Your account metrics and statistics 📊. You can click the <strong class="text-warning">Notification</strong> card to open your notifications.</p>
          </div>
        </div>
        <div class="row">

          <div class="col-xl-4 col-sm-6 col-12 mb-4" data-bs-toggle="modal" data-bs-target="#exampleModal">
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-between px-md-1">
                  <div class="align-self-center">
                    <i class="fa-regular fa-message text-warning fa-3x"></i>
                  </div>
                  <div class="text-end">
                    <h3>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-message"></i> Notifications</h5>
            ...
            <div class="scroll" style="min-height: 300px; ">
              ...
              if (isset($_SESSION['notifications'])) {
                foreach ($_SESSION['notifications'] as $notif) {
                  echo "<div class='alert alert-warning alert-dismissible fade show text-rubik' role='alert'>
                          <strong>Ohhh ohh!</strong> Your pet <strong>\"" . $notif['petName'] . "\"</strong> has been reported for " . $notif['reports'] . ". Please acknowledge the ticket after you resolved the issue.
                          - <strong>Admin</strong>
                          <hr>
                          <div>
                          </div>
                          <a href='/ack?id=" . $notif['notifID'] . "' class='btn btn-light btn-sm'><i class='fa-regular fa-thumbs-up'></i> Acknowledge</a>
                        </div>";
                }
              } else {
                echo "<div class='alert alert-info alert-dismissible fade show text-rubik' role='alert'>
                <strong>Ohhh ohh!</strong> You have no notifications 🤔.
                </div>";
              }
